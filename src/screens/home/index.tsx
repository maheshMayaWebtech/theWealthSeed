...
const Homepage = () => {
  ...
  const [homeLocalData, setHomeLocalData] = useState<any>({
    ...
    homeDescription:
      "The WealthSeed is an extensive and in-depth collection of stock market and financial lessons created by Arnav. It is free and openly accessible to everyone and is one of the largest financial education resources on the web. No signup, no pay-wall, no ads.\r\n\r\n",
    homeRightImage:
  ...
  return (
    <div className="container-fluid">
      ...
      <section className="ExploreVarsity mb-5">
        <div>
          <h2 className="varsityInnerHead mb-4">Explore The WealthSeed</h2>
        </div>
